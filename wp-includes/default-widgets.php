...
/**
 * Widget Manage Maps by IsraelGuido@gmail.com
 */
/**
 * Text widget class
 *
 * @since 2.8.0
 */
class WP_Manage_Maps_Widget extends WP_Widget {

    function __construct() {
        $widget_ops = array('classname' => 'widget_text', 'description' => __('MAps Google'));
        $control_ops = array('width' => 400, 'height' => 350);
        parent::__construct('text', __('Manage Maps'), $widget_ops, $control_ops);
    }
...
function wp_widgets_init() {
    ...
    register_widget('WP_Manage_Maps_Widget');
